...
if (isset($_GET['Token']) && isset($_GET['type'])) {
    ...
    // Decode the ID
    $id = $fun->customDecode($encodedId,'gallery');
    $type=$_GET['type'];
...
<body>
    ...
    <div class="content">
    <form id="menuForm" action="gallery.php" method="post" enctype="multipart/form-data">
...
<?php
if(!empty($image)){
   echo ' <img src="'.$webUrlfun.'/uploades/gallery/'.$image.'"> ';   
}
